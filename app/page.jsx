...
const Home = () => {
  return (
    <div className="pt-[50px] md:pt-[60px] overflow-hidden">
      ...
      {/* Hero */}
      <div className="grid sm:grid-cols-3 py-10 sm:py-20">
        <div className="w-[100vw] sm:w-auto flex flex-col text-center sm:text-left sm:ml-[7vw] sm:min-w-[500px] justify-center text-black playfair my-10">
          <h1 className="text-4xl lg:text-6xl">Take photos!</h1>
          <h2 className="text-2xl lg:text-4xl">They last a lifetime.</h2>
        </div>
        <div className="col-span-2 px-5 sm:px-20 lg:mx-20 m-auto">
