export default function PriceBlock({ time, cost, numPhotos, timeRange, color = "#4EA09D" }) {
    return (
      <div className="inline-block w-[90vw] sm:w-[400px] lg:w-[500px] 2xl:w-[600px] p-2 sm:p-12 xl:p-8 text-white garamond sm:h-[300px]">
...
export function PriceBlockSubscription({time, cost, numPhotos}){
    return (
        <div className="inline-block w-[90vw] sm:w-[400px] lg:w-[500px] 2xl:w-[600px] p-2 sm:p-12 xl:p-8 text-white garamond sm:h-[300px]">
            ...
            {/* Title */}
            <div className="bg-[#FF89A4] text-center p-5">
